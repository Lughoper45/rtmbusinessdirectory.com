...
const CanadaMap = () => {
  ...
  const getProvinceColor = (code: string) => {
    ...
    if (activeProvince === code) return "fill-primary/70";
    return "fill-surface-light hover:fill-primary/40";
  };
          ...
          <div className="lg:col-span-2 relative">
            ...
            >
              ...
              <path
                ...
                className={`${getProvinceColor("YT")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("NT")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("NU")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("BC")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("AB")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("SK")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("MB")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("ON")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("QC")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("NB")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("NS")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("PE")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
              ...
              <path
                ...
                className={`${getProvinceColor("NL")} stroke-white/30 stroke-1 cursor-pointer transition-all duration-300`}
            ...
            {activeProvince && !selectedProvince && (
              <div className="absolute top-4 left-4 bg-background text-foreground p-4 rounded-xl shadow-lg animate-fade-in">
          ...
          <div className="lg:col-span-1">
                ...
                <div className="space-y-4">
                  <div className="bg-white/5 rounded-xl p-4 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/60">Registered Businesses</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 rounded-xl p-4 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/60">Grants Available</p>
                    </div>
                  </div>
                  ...
                  <button className="w-full mt-4 bg-primary hover:bg-primary/90 text-white py-3 rounded-xl font-medium transition-colors">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="bg-white/5 rounded-xl p-4 text-center">
                ...
                <p className="text-xs text-white/60">Total Businesses</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4 text-center">
                <p className="text-3xl font-bold text-accent">$2.3B</p>
                <p className="text-xs text-white/60">Grants Available</p>
              </div>
            </div>
          </div>
        </div>
